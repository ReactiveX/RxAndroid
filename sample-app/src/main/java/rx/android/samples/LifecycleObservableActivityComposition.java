 ...
 */
public class LifecycleObservableActivityComposition extends Activity {

    private static final String TAG = LifecycleObservableActivityComposition.class.getSimpleName();
